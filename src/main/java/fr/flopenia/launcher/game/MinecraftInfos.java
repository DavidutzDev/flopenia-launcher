...
public class MinecraftInfos {
    ...
    public static final String CURSE_MODS_LIST_URL = "https://flopenia.000webhostapp.com/FlopeniaLauncher/mods_list.json";
    public static final String MODS_LIST_URL = "https://flopenia.000webhostapp.com/FlopeniaLauncher/mods_list.json";

    public boolean OPTIONAL_MOD_SCHEMATICA;

    public void setOPTIONAL_MOD_SCHEMATICA(boolean OPTIONAL_MOD_SCHEMATICA) {
        this.OPTIONAL_MOD_SCHEMATICA = OPTIONAL_MOD_SCHEMATICA;
    }
}
